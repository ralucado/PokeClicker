...
const vector<int> FROM_EGG = {1, 4, 7, 10, 13, 16, 19, 21, 23, 25, 27, 29, 32, 35, 37, 39, 41, 43, 46, 48, 50, 52, 54, 56, 58, 60, 63, 66, 69, 72,
...
/*
const vector<int> FROM_EGG = {27, 54, 56, 83, 84, 111, 138, 140};
putos pokemons problematics.... soc imbecil xD
*/
